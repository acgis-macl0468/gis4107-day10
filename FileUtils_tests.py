...
def test_getFileContent():
    desc = "File exists."
    expected = "this line was added using python"
    actual = ""
    print_test_results(mut.getFileContent, desc, expected, actual)
...
script_folder = os.path.dirname(os.path.abspath("demo.txt"))
